...
public struct CreateCustomerRequest: Codable {
    ...
    public init(idempotencyKey: String?, givenName: String?, familyName: String?, companyName: String?, nickname: String?, emailAddress: String?, address: Address?, phoneNumber: String?, referenceId: String?, note: String?, birthday: String?) {
