...
public struct OrderServiceCharge: Codable {
    ...
    public init(uid: String?, name: String?, catalogObjectId: String?, percentage: String?, amountMoney: Money?, appliedMoney: Money?, totalMoney: Money?, totalTaxMoney: Money?, calculationPhase: OrderServiceChargeCalculationPhase?, taxable: Bool?, taxes: [OrderLineItemTax]?, appliedTaxes: [OrderLineItemAppliedTax]?) {
        self.uid = uid
        self.name = name
