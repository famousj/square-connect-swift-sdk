...
public struct Checkout: Codable, Identifiable {
    ...
    public init(id: String?, checkoutPageUrl: URL?, askForShippingAddress: Bool?, merchantSupportEmail: String?, prePopulateBuyerEmail: String?, prePopulateShippingAddress: Address?, redirectUrl: URL?, order: Order?, createdAt: String?, additionalRecipients: [AdditionalRecipient]?) {
        self.id = id
